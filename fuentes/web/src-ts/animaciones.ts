...
//     private vel : Vec3 = this.vel_ini
    ...
    private ang_grad   : number = 0
    private w_grad_sec : number = 360.0
    ...
    {
        super()
        this.nombre = "Animación 1"
        
        const re = 0.1 // radio de la esfera  
        const mat_traX = CMat4.traslacion( new Vec3([1.0, 0.0, 0.0]))
        ...
        malla_esfera.matrizModelado = mat_traX.componer( mat_escR ).componer( mat_traY )
